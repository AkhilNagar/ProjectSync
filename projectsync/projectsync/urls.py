...
urlpatterns = [
    ...
    path('project/<int:project_id>/create_announcement/', views.create_announcement, name='create_announcement'),
    path('project/<int:project_id>/edit_project/', views.edit_project, name='edit_project'),
